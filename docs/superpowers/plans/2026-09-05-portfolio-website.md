...
Юу амьд болсон, ямар URL, `TODO(Баттулга)` тэмдэглэгээтэй ямар баримтуудыг (нэрийн бичилт, компанийн нэр, албан тушаал, он сар, LinkedIn, боловсрол, PoweredMN) засах хэрэгтэйг жагсаах. Засвар бүр `src/content/` дотор хийгдэж, `main`-д push хийхэд автоматаар deploy болно гэдгийг сануулах.
